...
namespace Shared
{
    ...
    public enum EContainerFields : int
    {
    ...
    public enum EGameObjectFields : int
    {
    ...
    public enum EDynamicObjectFields : int
    {
